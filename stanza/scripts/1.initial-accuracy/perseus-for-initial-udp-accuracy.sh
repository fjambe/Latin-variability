...
# Runs UDPipe parsing + evaluation for all 5 treebanks using the Perseus model
...
# Model
MODEL_NAME="perseus"
MODEL_FILE="$BASE_MODEL_DIR/Perseus-param-emb-v210.udpipe"
...
for utreebank in "${treebanks[@]}"; do
    ...
    PARSED_FILE="$BASE_OUTPUT_DIR/THESIS-udp-initial-${ltreebank}-by-perseus.conllu"
