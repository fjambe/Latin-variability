...
# Runs UDPipe parsing + evaluation for all 5 treebanks using the LLCT model
...
# Model
MODEL_NAME="llct"
MODEL_FILE="$BASE_MODEL_DIR/LLCT-devbr-param-emb-v210.udpipe"
...
for utreebank in "${treebanks[@]}"; do
    ...
    PARSED_FILE="$BASE_OUTPUT_DIR/THESIS-udp-initial-${ltreebank}-by-llct.conllu"
