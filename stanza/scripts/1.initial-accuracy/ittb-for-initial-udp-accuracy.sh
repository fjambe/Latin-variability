...
# Runs UDPipe parsing + evaluation for all 5 treebanks using the ITTB model
...
# Model
MODEL_NAME="ittb"
MODEL_FILE="$BASE_MODEL_DIR/ITTB-devbr-param-emb-v210.udpipe"
...
for utreebank in "${treebanks[@]}"; do
    ...
    PARSED_FILE="$BASE_OUTPUT_DIR/THESIS-udp-initial-${ltreebank}-by-ittb.conllu"
