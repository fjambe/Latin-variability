...
# Script to train the ITTB v2.10 model with UDPipe 1.2 on DEV BRANCH
...
MODEL_OUTPUT=/lnet/work/people/gamba/UDPipe/udp-models_and_training/ITTB-devbr-param-emb-v210.udpipe
FASTTEXT_VEC=/lnet/work/people/gamba/sz-training/stanza/fasttext/Latin/cc.la.300.vec
TRAIN_DATA=/lnet/work/people/gamba/UD-devbranch/UD_Latin-ITTB-dev/la_ittb-ud-train.conllu
