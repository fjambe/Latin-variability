...
# script to train PROIEL v2.10 model with UDPipe 1.2
...
MODEL_OUTPUT=/lnet/work/people/gamba/UDPipe/udp-models_and_training/PROIEL-param-emb-v210.udpipe
FASTTEXT_VEC=/lnet/work/people/gamba/sz-training/stanza/fasttext/Latin/cc.la.300.vec
TRAIN_DATA=/net/data/universal-dependencies-2.10/UD_Latin-PROIEL/la_proiel-ud-train.conllu
