...
# Runs UDPipe parsing + evaluation for all 5 treebanks using the PROIEL model
...
# Model
MODEL_NAME="proiel"
MODEL_FILE="$BASE_MODEL_DIR/PROIEL-param-emb-v210.udpipe"
...
for utreebank in "${treebanks[@]}"; do
    ...
    PARSED_FILE="$BASE_OUTPUT_DIR/THESIS-udp-initial-${ltreebank}-by-proiel.conllu"
