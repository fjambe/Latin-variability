...
# script to train LLCT v2.10 model with UDPipe 1.2 on DEVBRANCH
...
MODEL_OUTPUT=/lnet/work/people/gamba/UDPipe/udp-models_and_training/LLCT-devbr-param-emb-v210.udpipe
FASTTEXT_VEC=/lnet/work/people/gamba/sz-training/stanza/fasttext/Latin/cc.la.300.vec
TRAIN_DATA=/lnet/work/people/gamba/UD-devbranch/UD_Latin-LLCT-dev/la_llct-ud-train.conllu
