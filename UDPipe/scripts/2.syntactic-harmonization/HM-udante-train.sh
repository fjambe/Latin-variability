...
# Script to train the hm-udante model with UDPipe 1.2
# No tokenizer is trained
# fastText embeddings
# The harmonised version of UDante_train is used

UDPIPE_PATH=/lnet/work/people/gamba/UDPipe/udpipe
MODEL_OUTPUT=/lnet/work/people/gamba/UDPipe/udp-harmonisation/HM-udp-models/hm-udante.udpipe
FASTTEXT_VEC=/lnet/work/people/gamba/sz-training/stanza/fasttext/Latin/cc.la.300.vec
TRAIN_DATA=/lnet/work/people/gamba/GitHub/syntactic-harmonization/harmonized-treebanks/UD_Latin-UDante/HM-la_udante-ud-train.conllu
