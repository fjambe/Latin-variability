...
# Script to train the hm-ittb model with UDPipe 1.2
# No tokenizer is trained
# fastText embeddings
# Parameters are set according to UD 2.5 Models reproducible training, both for tagger and parser
# The harmonised version of ITTB_train is used

UDPIPE_PATH=/lnet/work/people/gamba/UDPipe/udpipe
MODEL_OUTPUT=/lnet/work/people/gamba/UDPipe/udp-harmonisation/HM-udp-models/hm-ittb.udpipe
FASTTEXT_VEC=/lnet/work/people/gamba/sz-training/stanza/fasttext/Latin/cc.la.300.vec
TRAIN_DATA=/lnet/work/people/gamba/GitHub/syntactic-harmonization/harmonized-treebanks/UD_Latin-ITTB/HM-la_ittb-ud-train.conllu
