...
# Script to train the mm-perseus model with UDPipe 1.2
...
# The morphologically harmonised version of Perseus_train is used

UDPIPE_PATH=/lnet/work/people/gamba/UDPipe/udpipe
MODEL_OUTPUT=/lnet/work/people/gamba/UDPipe/udp-harmonisation/morphoharmo/MM-udp-models/mm-perseus-feb24.udpipe
FASTTEXT_VEC=/lnet/work/people/gamba/sz-training/stanza/fasttext/Latin/cc.la.300.vec
TRAIN_DATA=/lnet/work/people/gamba/GitHub/morpho-harmonization/morpho-harmonized-treebanks/UD_Latin-Perseus/MM-la_perseus-ud-train.conllu
