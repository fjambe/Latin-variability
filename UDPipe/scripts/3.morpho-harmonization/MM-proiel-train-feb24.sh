# Script to train the mm-proiel model with UDPipe 1.2
...
# The morphologically harmonised version of PROIEL_train is used

UDPIPE_PATH=/lnet/work/people/gamba/UDPipe
MODEL_OUTPUT=/lnet/work/people/gamba/UDPipe/udp-harmonisation/morphoharmo/MM-udp-models/mm-proiel-feb24.udpipe
FASTTEXT_VEC=/lnet/work/people/gamba/sz-training/stanza/fasttext/Latin/cc.la.300.vec
TRAIN_DATA=/lnet/work/people/gamba/GitHub/morpho-harmonization/morpho-harmonized-treebanks/UD_Latin-PROIEL/MM-la_proiel-ud-train.conllu
...
$UDPIPE_PATH --train $MODEL_OUTPUT \
  ...
  --parser='iterations=30;embedding_upostag=20;embedding_feats=20;embedding_xpostag=0;embedding_form=50;embedding_form_file=/lnet/work/people/gamba/sz-training/stanza/fasttext/Latin/cc.la.300.vec;embedding_lemma=0;embedding_deprel=20;learning_rate=0.01;learning_rate_final=0.001;l2=0.5;hidden_layer=200;batch_size=10;transition_system=link2;transition_oracle=static;structured_interval=8' \
  $TRAIN_DATA
